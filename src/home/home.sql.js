...
`SELECT
    u.user_id, u.image_url AS profileImg, u.account,
    s.shorts_id, s.image_url AS shortsImg, s.phrase, s.phrase_x, s.phrase_y, s.title, s.content, s.tag,
...
GROUP BY s.shorts_id, s.created_at
